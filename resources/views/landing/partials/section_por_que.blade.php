  ...
  <div class="max-w-7xl mx-auto px-6">
    ...
    <div class="text-center">
      ...
      <p class="reveal mt-3 text-slate-600 max-w-3xl mx-auto">
        Modelo sólido, respaldo operativo y branding que impulsa tu crecimiento como distribuidor.
      </p>
    </div>
    ...
    @php
      $beneficios = [
        ['title' => 'Comisiones residuales de por vida',        'icon' => '💹'],
        ['title' => 'Mejores márgenes de ganancia',             'icon' => '📈'],
        ['title' => 'Soporte y acompañamiento más cercano',     'icon' => '📞'],
        ['title' => 'Atención al cliente especializada',        'icon' => '🌟'],
        ['title' => 'Paquete de publicidad incluido',           'icon' => '🎁'],
        ['title' => 'Inversión accesible y flexible',           'icon' => '💰'],
        ['title' => 'SIMs preactivadas con todos los planes',   'icon' => '📦'],
        ['title' => 'Materiales promocionales en tienda online','icon' => '🛍️'],
      ];
    @endphp
        ...
        <div class="reveal feature-card group" style="--delay: {{ 90 * $i }}ms">
          ...
          <div class="relative z-[1] p-5">
            ...
            <p class="mt-3 text-sm text-slate-600">
              Impulsa tu negocio con marca, soporte y herramientas diseñadas para maximizar resultados.
            </p>
          </div>
        </div>
      @endforeach
...
.feature-card:hover {
  ...
  box-shadow: 0 16px 40px rgba(65, 156, 246, .18),
              0 6px 20px rgba(132, 79, 240, .15);
