<section id="faq" class="py-20 bg-slate-50">
  <div class="max-w-5xl mx-auto px-4">
    ...
    @php
      ...
      $waNumber = '3342802855';
      $waMsg    = rawurlencode('Hola, necesito soporte sobre el programa de distribuidores Bromovil.');
...
<style>
  ...
  section#faq { font-family: 'Poppins', sans-serif; }
</style>
